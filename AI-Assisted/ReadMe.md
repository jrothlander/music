I do not use AI to generate the music. I use it to help with several things, but not to generate the music. All of my 8-bit music is built using my own 
Atari POKEY chip emulator and not AI. However, I am experimenting with using AI to compose the music using the emulator as well. That music will be in 
...
* Create unit tests and debug the software
